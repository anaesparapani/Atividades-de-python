...
veiculos2 = veiculos1[:]
del veiculos1[2]
# print("Veículo 1:",veiculos1)
# print("Veículo 2:", veiculos2)
...
veiculos4 = veiculos2[0:-1] #ele não pega o último, ele pega o anterior que você indicou
# print(veiculos4)
...
#Para isso, usamos palavra chave "in" e "not in":
naosei = ["A", "B", 18, 15]
print("A" in naosei)
